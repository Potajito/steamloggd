...
def steam_login (page: Page) -> Page:
    ...
    try:      
        ...
        username_div: ElementHandle = page.get_by_text("Sign in with account name")
        user_input_field:ElementHandle = username_div.locator('xpath=following-sibling::input')
        password_div = page.get_by_text("Password")
        password_input_field:ElementHandle = password_div.locator('xpath=following-sibling::input')
